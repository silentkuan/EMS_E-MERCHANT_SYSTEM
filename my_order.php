                                ...
                                <table id='example' class="table table-hover">
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            `order`.user_id='$uid' and order_status.id=`order`.order_status and `order`.merchant_id='$merchant_id' order by `order`.order_id desc");
											while($row=mysqli_fetch_assoc($res)){
											?>
                                            <tr>
												<td class="product-add-to-cart"><a href="my_order_details.php?order_id=<?php echo $row['order_id']?>&merchant_name=<?=$merchant_name?>">
