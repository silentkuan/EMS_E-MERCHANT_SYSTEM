        ...
        <div class="wishlist-area ptb--100 bg__white">
            <div class="container">
                <div class="row">
                    ...
                    <div id="alert-message" class="alert alert-danger fade in  ">Sorry, your order face some error. Your order placed unsucessfully. You may try to place order again.</div>
