...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == 'status') {
        ...
        $update_status_sql = "UPDATE categories SET status = ? WHERE id = ?";
...
$stmt = $con->prepare("SELECT * FROM categories WHERE merchant_id = ?");
...
<div class="content pb-0">
	<div class="orders">
		  ...
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   ...
				   <h4 class="box-link"><a href="manage_categories.php?merchant_name=<?= $merchant_name ?>">Add Categories</a> </h4>
				</div>
				<div class="card-body--">
       ...
       while ($row = mysqli_fetch_assoc($res)) { ?>
        ...
        echo "<span class='badge badge-edit'><a href='manage_categories.php?merchant_name=$merchant_name&id=" . $row['id'] . "'>Edit</a></span>&nbsp;";
