...
<div class="content pb-0">
  ...
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title font-weight-bold">Total of Sales (This month) </h4>
        <p class="card-text display-4"><?=$total_sales!="" ?$total_sales:0?></p>
  ...
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text display-4"><?=$totalOrders!="" ?$totalOrders:0?></p>
  ...
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text display-4"><?=$totalProducts!="" ?$totalProducts:0?></p>
  ...
  <div class="col-sm-3">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text display-4"><?=$totalUser!="" ?$totalUser:0?></p>
