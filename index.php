...
$resBanner=mysqli_query($con,"select * from banner where status='1' and merchant_id='$merchant_id'");
                        ...
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img style="width:50%;" src="<?php echo BANNER_SITE_PATH.$rowBanner['image']?>" >
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="category">
                                    ...
                                    <div class="fr__hover__info">
                                        ...
                                        <?php if(isset($_COOKIE['USER_LOGIN']) && $_COOKIE['USER_LOGIN']!=""){ ?>
											<li><a href="javascript:void(0)" onclick="wishlist_manage('<?php echo $list['id']?>','add','<?php echo $merchant_id?>','<?=$merchant_name?>')"><i class="icon-heart icons"></i></a></li>
											<?php }?>
