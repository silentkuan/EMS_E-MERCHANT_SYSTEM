...
$res=mysqli_query($con,"select * from coupon_master where coupon_code='$coupon_str' and status='1' and merchant_id='$merchant_id'");
...
if($count>0){
	...
	if($cart_min_value>$cart_total){
		...
		$jsonArr=array('is_error'=>'no','result'=>$final_price,'dd'=>number_format((float)$dd, 2, '.', '') );
	}
