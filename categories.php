                        ...
                        <div class="htc__product__rightidebar">
                            <div class="htc__grid__top">
                                <div class="htc__select__option">
                                    <select class="ht__select" onchange="sort_product_drop('<?php echo $cat_id?>','<?php echo SITE_PATH?>','<?php echo $merchant_name?>')" id="sort_product_id">
										...
										<div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
											<div class="category">
												<div class="ht__cat__thumb">
													<a href="product.php?merchant_name=<?=$merchant_name?>&id=<?php echo $list['id']?>">
												...
												<div class="fr__hover__info">
													...
													<li><a href="javascript:void(0)" onclick="wishlist_manage('<?php echo $list['id']?>','add','<?php echo $merchant_id?>')"><i class="icon-heart icons"></i></a></li>
													<?php }?>
													<li><a href="javascript:void(0)" onclick="manage_cart('<?php echo $list['id']?>','add','','<?=$merchant_name?>')"><i class="icon-handbag icons"></i></a></li>
													</ul>
												</div>
												<div class="fr__product__inner">
													<h4><a href="product-details.html"><?php echo $list['name']?></a></h4>
													<ul class="fr__pro__prize">
														<li class="old__prize">RM<?php echo $list['mrp']?></li>
														<li>RM<?php echo $list['price']?></li>
													</ul>
												</div>
											</div>
										</div>
